...
\author{Tigany Zarrouk and Mattia Gaggi } % Author(s)
...
%\begin{thebibliography}{1}  
 ...
 %\bibitem{Christensen}
%\newblock Christensen \emph{et al.}, 
%\newblock \emph{Simple Model To Identify Critical Regions in Atrial Fibrillation}
%Phys. Rev. Lett. 114, 028104
