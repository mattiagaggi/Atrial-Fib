...
class heart:
    def __init__(self,L=100,p_unexcitable=0.05,p_fibrosis= 0.83,p_dysf=0.05):
	...
	"""
        ...
        self.excitation=25 #Value of excitation on the lattice
        self.heartbeatsteps=110 #Time period between excitation wavefronts
