...
class run: #Class to run code
    def __init__(self,heart,plot=False,store=True,stepsstored=1000,replot=False):
        ...
        if self.plot or self.replot:
            ...
            self.ax1.set_title('Lattice - Nu=0.1')
            ...
            if self.replot==True:
                ...
                self.anim1 = animation.FuncAnimation(self.figure, self.replotfigure,
                            frames=2000, interval=self.interval, blit=False) 
...
r.anim1.save('AFChristensenNu01Trial.mp4', fps=25, extra_args=['-vcodec', 'libx264'])
#r.anim1.save('')
#r.plotecg()
plt.show()
