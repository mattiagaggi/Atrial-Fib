...
fileobj0 = open('listoffibrillationtimes_L100.pkl', 'wb')
fileobj1 = open('risk_L100.pkl', 'wb')
fileobj2 = open('riskerrorr_L100.pkl', 'wb')
fileobj4 = open('numberfibrillations_L100.pkl', 'wb')
fileobj5 = open('nfibaverage_L100.pkl', 'wb')
fileobj6 = open('nfiberr_L100.pkl', 'wb')
fileobj7 = open('tinfib_L100.pkl', 'wb')
fileobj8 = open('dysfgrids_L100.pkl', 'wb')
fileobj9 = open('fibrosisgrid_L100.pkl', 'wb')
...
ax.plot(m_trans_conn,risk, 'b+', label = 'Original Model - L=100')
