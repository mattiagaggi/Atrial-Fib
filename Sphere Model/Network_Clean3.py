...
def define_connections(s):
    ...
    rang_val = int((num_func(s.recursion_level)+1)/2.) -1 #-2
...
#
"""
d=open('horiz_conn_rec_6.pkl','rb')
hconn=pickle.load(d)
f=open('vert_conn_rec_6.pkl','rb')
vconn=pickle.load(f)
e=open('pent_ind_rec_6.pkl','rb')
pent_ind=pickle.load(e)
g=open('colours_rec_6.pkl','rb')
colours=pickle.load(g)
h=open('sph_rec_6.pkl','rb')
s=pickle.load(h)
...
"""
"""
fileobj1 = open('horiz_conn_rec_6.pkl', 'wb')
pickle.dump(hconn, fileobj1, -1)

fileobj2 = open('vert_conn_rec_6.pkl', 'wb')
pickle.dump(vconn, fileobj2, -1)

fileobj0 = open('pent_ind_rec_6.pkl', 'wb')
pickle.dump(pent_ind, fileobj0, -1)

fileobj3 = open('colours_rec_6.pkl', 'wb')
