...
class heart:
    ...
    def onestep(self): #Propagating to the next time step
        ...
        self.gridofexcite[self.delayprop > 10] = self.excitation##INSERT EQUATION FOR RESTITUTION CURVE HERE###
...
"""
h = heart(L=200,p_unexcitable=0.05,p_fibrosis= 0.2,p_dysf=0.05, excitethresh = 2)
