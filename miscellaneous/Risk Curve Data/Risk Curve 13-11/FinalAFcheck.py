...
class heart:
	...
	"""
        ...
        self.excitation=5 #Value of excitation on the lattice
        self.heartbeatsteps=20 #Time period between excitation wavefronts
    ...
    def excitecolumn(self):
        ...
        self.gridofexcite[1,2] = self.excitation
        self.grid[1,2] = self.excitation
    ...
    def dysfcheck(self):
        ...
        print("dysfcheck grid, non excite")
        print(randgrid)
        print("dysfgrid")
        print(self.dysfgrid)
...
h = heart(L=4,p_unexcitable=0.05,p_fibrosis= 1,p_dysf=0.5)
