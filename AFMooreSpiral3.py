...
class heart:
    ...
    def onestep(self): #Propagating to the next time step
        ...
        #self.tempgrid[(self.tempgrid != self.excitation)] = 1
        ...
        self.gridofexcite[self.gridofexcite == 1*self.excitation] = 0
        self.gridofexcite[self.gridofexcite == 2*self.excitation] = 0
